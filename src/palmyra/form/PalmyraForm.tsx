import { forwardRef, RefObject, useContext, useEffect, useImperativeHandle, useRef } from "react";
...
const PalmyraForm = forwardRef(function PalmyraForm(props: IFormOptions, ref: RefObject<IForm>) {
